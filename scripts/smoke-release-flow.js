...
function main() {
  ...
  assertIncludes(installedSmokeJs, "installed onboarding Mira reads as a larger round avatar instead of an app icon tile", "installed smoke checks onboarding larger round Mira avatar");
  assertIncludes(installedSmokeJs, "installed onboarding Mira mouth stays as a soft short smile", "installed smoke checks onboarding Mira mouth softness");
  ...
  assertIncludes(installedSmokeJs, "installed feedback Mira mouth follows the soft short smile standard", "installed smoke checks feedback Mira mouth softness");
  assertIncludes(installedSmokeJs, "installed desktop Mira mouth follows the soft short smile standard", "installed smoke checks desktop Mira mouth softness");
