...
function main() {
  ...
  assertIncludes(installedSmokeJs, "installed feedback Mira day glow stays soft (dialed down for the small corner avatar)", "installed smoke checks feedback daytime Mira glow");
  assertIncludes(installedSmokeJs, "installed feedback Mira night glow stays soft (dialed down for the small corner avatar)", "installed smoke checks feedback night Mira glow");
