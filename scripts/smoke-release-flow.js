...
function main() {
  ...
  assertIncludes(installedSmokeJs, "installed feedback Mira day glow is synced to onboarding", "installed smoke checks feedback daytime Mira glow");
  assertIncludes(installedSmokeJs, "installed feedback Mira night glow is synced to onboarding", "installed smoke checks feedback night Mira glow");
